...
plt.xlabel('Audience Rating (percentage)')
plt.ylabel('Frequency')
plt.title('Audience Ratings by Frequency in Rotten Tomatoes Dataset')
...
#.keys())
plt.title('Top 15 Most Common Movie Genres in Rotten Tomatoes Dataset')
...
plt.axis('equal')
plt.title('Top 20 Most Common Original Release Years of Movies in Rotten Tomatoes Dataset')
...
plt.ylabel('Frequency')
plt.title('Critics Tomatometer Status Rankings by Frequency in Rotten Tomatoes Dataset')
